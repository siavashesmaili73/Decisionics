...
public class BleManager {
    ...
    private static final int DEFAULT_CONNECT_RETRY_INTERVAL = 1000;
    private static final int DEFAULT_MTU = 23;
    private static final int DEFAULT_MAX_MTU = 512;
    private static final int DEFAULT_WRITE_DATA_SPLIT_COUNT = 40;
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (!isBlueEnable()) {BleLog.e("Bluetooth not enable!");
